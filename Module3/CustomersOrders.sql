...
-- Use a LEFT OUTER JOIN so that a customer is listed even if they've made 
...
-- Sort the rows according to the total money spent, from the most spent to 
-- the least spent. (Tip: You should always GROUP BY on the column that is 
-- most likely to be unique in a row.)
